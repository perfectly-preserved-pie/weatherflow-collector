...
curl_message="weatherflow_system_events,collector_key=${collector_key},collector_type=${collector_type},host_hostname=${host_hostname},source=${function},event=healthcheck,health_check_collector_type=${health_check_collector_type} up=0";
...
curl_message="weatherflow_system_events,collector_key=${collector_key},collector_type=${collector_type},host_hostname=${host_hostname},source=${function},event=healthcheck,health_check_collector_type=${health_check_collector_type} up=1";
...
curl_message="weatherflow_system_stats,collector_key=${collector_key},collector_type=${collector_type},duration_type="health_check",host_hostname=${host_hostname},source=${function} duration=${health_check_duration}";
