...
##
## Send Netstat InfluxDB Metrics To InfluxDB
##

curl_message="weatherflow_system_stats,collector_key=${collector_key},collector_type=${collector_type},host_hostname=${host_hostname},source=${function},sysperf_type=netstat,netstat_app=influxdb netstat_established=${influxdb_established},netstat_finwait2=${influxdb_finwait2},netstat_closewait=${influxdb_closewait},netstat_listen=${influxdb_listen},netstat_timewait=${influxdb_timewait}";
...
##
## Send Netstat Loki Metrics To InfluxDB
##
...
##
## Send CPU, Memory, and Process Metrics To InfluxDB
##
...
curl_message="weatherflow_system_stats,collector_key=${collector_key},collector_type=${collector_type},duration_type="host_performance",host_hostname=${host_hostname},source=${function} duration=${host_performance_duration}";
